...
class QLearner(object):
    ...
    def __init__(
        ...
        self.alpha = alpha
        self.gamma = gamma
        self.rar = rar # Exploration Rate
        self.radr = radr # Rate of decay for Exploration Rate
        self.dyna = dyna
    ...
    def updateModel(self, s, a, s_prime, r):
        self.experiences[(s,a)] = (s_prime, r)

    def hallucinate(self):
        for _ in range(self.dyna):
            if len(self.experiences) == 0:
                break
            (s,a), (s_prime,r) = rand.choice(list(self.experiences.items()))
    ...
    def query(self, s_prime, r):
        ...
        # Update table with Q-learning formula
